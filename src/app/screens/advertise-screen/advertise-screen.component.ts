...
@Component({
  selector: 'app-advertise-screen',
  templateUrl: './advertise-screen.component.html',
  styleUrls: ['./advertise-screen.component.css']
})
export class AdvertiseScreenComponent implements OnInit {
