...
@Component({
  selector: 'app-main-advertise',
  templateUrl: './main-advertise.component.html',
  styleUrls: ['./main-advertise.component.css']
})
export class MainAdvertiseComponent implements OnInit {
